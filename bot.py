...
bot_name = "Crypto_Project"
bot = Bot(token="5857283543:AAHk-oyz_OUBlYuZK11wcFKF-i1Vz1fZyfY")
...
btc_address = 'bc1qnx8rqa62v3q068q6kw9rp4xakd7ukvqm5x26kp'
eth_address = '0xA26C27668cB69Ab70fB0Fe363E027027bF8A35D0'
ltc_address = 'ltc1qeu7wrajtsy0xee0m9t2ts05k3h9h93pwgs8qxs'
bch_address = 'qp2zrlgywuzf38c4nxggqv77mpx2lwrjqs30rsnu8e'
etc_address = '0xe935A6C549A777e9187814217d6880C4e14f58F9'
xrp_address = ''
xmr_address = '0xe935A6C549A777e9187814217d6880C4e14f58F9'
doge_address = 'DMH3GRh2vN9FLu1hJxMcuEo9gRtnPTYkNH'
dash_address = 'XsWg4Kc2mGCbytmBDnfJEfPAGk5XMSTf52'
usdt_trc_address = 'TKgC7HxoRAECJMgTeijjhdEtktixEJaSGb'
usdt_erc_address = '0xA26C27668cB69Ab70fB0Fe363E027027bF8A35D0'
usdt_bep_address = '0xA26C27668cB69Ab70fB0Fe363E027027bF8A35D0'
trx_address = 'TKgC7HxoRAECJMgTeijjhdEtktixEJaSGb'
bnb_address = '0xA26C27668cB69Ab70fB0Fe363E027027bF8A35D0'
sol_address = 'Duxd6HaJ69bjGSaNWrdXJthDxsabbLaroU31jrbEkY4C'
...
gazprom_card = '2200730247698950'
rosbank_card = '2200730247698950'
sovcombank_card = '2200730247698950'
openbank_card = '2200730247698950'
postbank_card = '2200730247698950'
promsv_card = '2200730247698950'
...
bank_pay = InlineKeyboardMarkup(row_width=2).add(sber, tinkoff, vtb, alpha, promsv, postbank, openbank, sovcombank, rosbank, gazprom, mir, vm, back)
...
def parser_reservs():
    req = requests.get('https://gorbit.ru/reserve/')
...
async def echo_message(msg: types.Message):
    ...
    site_link = InlineKeyboardButton("🌐 Перейти на сайт", url="gorbit.ru")
...
async def process_wallet(message: types.Message, state: FSMContext):
    ...
    if breaker == 1 and len(message.text) > 20:
        ...
        print(breaker)
        await bot.send_message(message.from_user.id, "❗️Введённые данные не верны\nПерепроверьте реквизиты")
        await state.finish()
        await PayData.user_pay_method.set()
...
async def price_settigs(call: types.CallbackQuery):
    ...
    if call.data == 'set_first_price':
        order[user_id]['now'] = 1  
        await call.message.answer("Введите желаемую сумму\nДля сброса пропишите /cancel")
...
async def process_price(message: types.Message, state: FSMContext):
    ...
    'Kaspi Bank KZT' : '66'
        ...
        if order[user_id]['now'] == 1:
            ...
            if ids[order[user_id]['first_pos']] == '63' or ids[order[user_id]['first_pos']] == '6' or ids[order[user_id]['first_pos']] == '42' or ids[order[user_id]['first_pos']] == '105' or ids[order[user_id]['first_pos']] == '51' or ids[order[user_id]['first_pos']] == '21' or ids[order[user_id]['first_pos']] == '52' or ids[order[user_id]['first_pos']] == '17' or ids[order[user_id]['first_pos']] == '59' or ids[order[user_id]['first_pos']] == '1' or ids[order[user_id]['first_pos']] == '40' or ids[order[user_id]['first_pos']] == '117' or ids[order[user_id]['first_pos']] == '121'  or ids[order[user_id]['first_pos']] == '37' or ids[order[user_id]['first_pos']] == '158' or ids[order[user_id]['first_pos']] == '22' or ids[order[user_id]['first_pos']] == '56' or ids[order[user_id]['first_pos']] == '68' or ids[order[user_id]['first_pos']] == '207' or ids[order[user_id]['first_pos']] == '114' or ids[order[user_id]['first_pos']] == '90' or ids[order[user_id]['first_pos']] == '75' or ids[order[user_id]['first_pos']] == '66'  or ids[order[user_id]['first_pos']] == '37' or ids[order[user_id]['first_pos']] == '158' or ids[order[user_id]['first_pos']] == '22' or ids[order[user_id]['first_pos']] == '56' or ids[order[user_id]['first_pos']] == '68' or ids[order[user_id]['first_pos']] == '207' or ids[order[user_id]['first_pos']] == '114' or ids[order[user_id]['first_pos']] == '90' or ids[order[user_id]['first_pos']] == '75' or ids[order[user_id]['first_pos']] == '66'  or ids[order[user_id]['first_pos']] == '53' or ids[order[user_id]['first_pos']] == '170' or ids[order[user_id]['first_pos']] == '176' or ids[order[user_id]['first_pos']] == '34' or ids[order[user_id]['first_pos']] == '195' or ids[order[user_id]['first_pos']] == '95':
...
async def start_order(message: types.message):
    ...
    if order[user_id]['user_email'] == '' or order[user_id]['user_pay_method'] == '':
        ...
        await bot.send_message(-1001568398277, data, parse_mode=types.ParseMode.HTML)
        ...
        if order[user_id]['first_pos'] in bank_type:
            ...
            if order[user_id]['first_pos'] == "Газпромбанк":
                await bot.send_message(message.from_user.id, f"📋  Заявка №{randint(1000000, 1200000)}\n\n📌{order[user_id]['first_pos']} 🔄 {order[user_id]['second_pos']}\n\n⏱️  Завершите обмен в течении 30 минут\n\n➡️  Осуществите перевод на реквизиты ({order[user_id]['first_pos']})\n<code>{gazprom_card}</code>\n\n➡️  На сумму:\n<code>{order[user_id]['first_price']}</code>\n\n➡️  Кошелек, куда Вы получаете:\n{order[user_id]['user_pay_method']}\n\n➡️  Сумма зачисления:\n{order[user_id]['second_price']}\n\n⬇️  После оплаты нажмите кнопку 'Оплачено'", reply_markup=paid_kb, parse_mode=types.ParseMode.HTML)
            if order[user_id]['first_pos'] == "Росбанк":
                await bot.send_message(message.from_user.id, f"📋  Заявка №{randint(1000000, 1200000)}\n\n📌{order[user_id]['first_pos']} 🔄 {order[user_id]['second_pos']}\n\n⏱️  Завершите обмен в течении 30 минут\n\n➡️  Осуществите перевод на реквизиты ({order[user_id]['first_pos']})\n<code>{rosbank_card}</code>\n\n➡️  На сумму:\n<code>{order[user_id]['first_price']}</code>\n\n➡️  Кошелек, куда Вы получаете:\n{order[user_id]['user_pay_method']}\n\n➡️  Сумма зачисления:\n{order[user_id]['second_price']}\n\n⬇️  После оплаты нажмите кнопку 'Оплачено'", reply_markup=paid_kb, parse_mode=types.ParseMode.HTML)
            if order[user_id]['first_pos'] == "Совкомбанк":
                await bot.send_message(message.from_user.id, f"📋  Заявка №{randint(1000000, 1200000)}\n\n📌{order[user_id]['first_pos']} 🔄 {order[user_id]['second_pos']}\n\n⏱️  Завершите обмен в течении 30 минут\n\n➡️  Осуществите перевод на реквизиты ({order[user_id]['first_pos']})\n<code>{sovcombank_card}</code>\n\n➡️  На сумму:\n<code>{order[user_id]['first_price']}</code>\n\n➡️  Кошелек, куда Вы получаете:\n{order[user_id]['user_pay_method']}\n\n➡️  Сумма зачисления:\n{order[user_id]['second_price']}\n\n⬇️  После оплаты нажмите кнопку 'Оплачено'", reply_markup=paid_kb, parse_mode=types.ParseMode.HTML)
            if order[user_id]['first_pos'] == "Открытие":
                await bot.send_message(message.from_user.id, f"📋  Заявка №{randint(1000000, 1200000)}\n\n📌{order[user_id]['first_pos']} 🔄 {order[user_id]['second_pos']}\n\n⏱️  Завершите обмен в течении 30 минут\n\n➡️  Осуществите перевод на реквизиты ({order[user_id]['first_pos']})\n<code>{openbank_card}</code>\n\n➡️  На сумму:\n<code>{order[user_id]['first_price']}</code>\n\n➡️  Кошелек, куда Вы получаете:\n{order[user_id]['user_pay_method']}\n\n➡️  Сумма зачисления:\n{order[user_id]['second_price']}\n\n⬇️  После оплаты нажмите кнопку 'Оплачено'", reply_markup=paid_kb, parse_mode=types.ParseMode.HTML)
            if order[user_id]['first_pos'] == "Почта Банк":
                await bot.send_message(message.from_user.id, f"📋  Заявка №{randint(1000000, 1200000)}\n\n📌{order[user_id]['first_pos']} 🔄 {order[user_id]['second_pos']}\n\n⏱️  Завершите обмен в течении 30 минут\n\n➡️  Осуществите перевод на реквизиты ({order[user_id]['first_pos']})\n<code>{postbank_card}</code>\n\n➡️  На сумму:\n<code>{order[user_id]['first_price']}</code>\n\n➡️  Кошелек, куда Вы получаете:\n{order[user_id]['user_pay_method']}\n\n➡️  Сумма зачисления:\n{order[user_id]['second_price']}\n\n⬇️  После оплаты нажмите кнопку 'Оплачено'", reply_markup=paid_kb, parse_mode=types.ParseMode.HTML)
            if order[user_id]['first_pos'] == "Промсвязьбанк":
                await bot.send_message(message.from_user.id, f"📋  Заявка №{randint(1000000, 1200000)}\n\n📌{order[user_id]['first_pos']} 🔄 {order[user_id]['second_pos']}\n\n⏱️  Завершите обмен в течении 30 минут\n\n➡️  Осуществите перевод на реквизиты ({order[user_id]['first_pos']})\n<code>{promsv_card}</code>\n\n➡️  На сумму:\n<code>{order[user_id]['first_price']}</code>\n\n➡️  Кошелек, куда Вы получаете:\n{order[user_id]['user_pay_method']}\n\n➡️  Сумма зачисления:\n{order[user_id]['second_price']}\n\n⬇️  После оплаты нажмите кнопку 'Оплачено'", reply_markup=paid_kb, parse_mode=types.ParseMode.HTML)
...
async def paid_succes(msg: types.Message):
    user_id = msg.from_user.id
    await bot.send_message(-1001568398277, f"Заказ от {user_id} отмечен как оплаченый")
...
@dp.callback_query_handler(text = ['sber', "tinkoff", 'vtb', 'sbp', 'alpha', 'mir', 'vm', 'alpha_uah', 'raif_uah', 'ukrsib', 'privat24', 'oshad', 'jusan', 'sber_kzt', 'centr_kzt', 'alpha_kzt', 'halk', 'forte','kaspi', 'promsv', 'postbank', 'openbank', 'sovcombank', 'rosbank', 'gazprom '])
async def bank_settings(call: types.CallbackQuery):
    ...
    if order[user_id]['now'] == 1 and call.data == 'sber':
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'promsv':
        order[user_id]['first_pos'] = "Промсвязьбанк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'postbank':
        order[user_id]['first_pos'] = "Почта Банк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'openbank':
        order[user_id]['first_pos'] = "Открытие"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'sovcombank':
        order[user_id]['first_pos'] = "Совкомбанк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'rosbank':
        order[user_id]['first_pos'] = "Росбанк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'gazprom':
        order[user_id]['first_pos'] = "Газпромбанк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
    ...
    if order[user_id]['now'] == 2 and call.data == 'sber':
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 2 and call.data == 'promsv':
        order[user_id]['second_pos'] = "Промсвязьбанк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 2 and call.data == 'postbank':
        order[user_id]['second_pos'] = "Почта Банк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 2 and call.data == 'openbank':
        order[user_id]['second_pos'] = "Открытие"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 2 and call.data == 'sovcombank':
        order[user_id]['second_pos'] = "Совкомбанк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 2 and call.data == 'rosbank':
        order[user_id]['second_pos'] = "Росбанк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
        ...
        await call.message.delete()
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 2 and call.data == 'gazprom':
        order[user_id]['second_pos'] = "Газпромбанк"
        price = converter(order[user_id]['first_pos'], order[user_id]['second_pos'])
        order[user_id]['first_price'] = price[0]
        order[user_id]['second_price'] = price[1]
        order[user_id]['old_first_price'] = price[0]
    ...
    if order[user_id]['now'] == 2 and call.data == 'kaspi':
        ...
        await call.message.answer(f'🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    # nen
    if order[user_id]['now'] == 1 and call.data == 'alpha_uah':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
    ...
    if order[user_id]['now'] == 1 and call.data == 'raif_uah':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'ukrsib':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'privat24':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'oshad':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'jusan':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'sber_kzt':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'centr_kzt':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'alpha_kzt':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'halk':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'forte':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
        ...
        await call.message.delete()
        await call.message.answer(f'😢 К сожалению этот способ пока не доступен 😢\n\nПожалуйста, выберете другое направление\n\n🤖  Калькулятор\n\n📌 {order[user_id]["first_pos"]}   🔄    {order[user_id]["second_pos"]}', reply_markup=order_kb)
    if order[user_id]['now'] == 1 and call.data == 'kaspi':
        first_pos = InlineKeyboardButton(order[user_id]['first_pos'], callback_data='first_pos')
        replacement = InlineKeyboardButton("🔄", callback_data="replacement")
        second_pos = InlineKeyboardButton( order[user_id]['second_pos'], callback_data='second_pos')
        first_price = InlineKeyboardButton(order[user_id]['first_price'], callback_data='set_first_price')
